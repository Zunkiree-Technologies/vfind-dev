...
export default function Footer() {
  return (
    <footer className="text-gray-200 min-h-fit p-4 mt-4">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[500px_1fr_1fr_1fr] gap-8 md:gap-10">
        ...
        <div className="md:col-span-2 lg:col-span-1">
          ...
          <div className="flex gap-4 mt-5">
            <a
              href="#"
              className="w-10 h-10 flex items-center justify-center rounded-full bg-[#F5F6FA] border border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-white transition-all duration-300"
            >
              <Linkedin size={18} />
            </a>
            <a
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="blogs" className="text-black hover:text-blue-600 transition-all duration-200">
                Resources
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="/contact" className="text-black hover:text-blue-600 transition-all duration-200">
                Contact Us
              </a>
            </li>
            <li>
              <a href="/about" className="text-black hover:text-blue-600 transition-all duration-200">
                About Us
              </a>
            </li>
          </ul>
